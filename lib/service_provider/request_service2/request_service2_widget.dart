...
class RequestService2Widget extends StatefulWidget {
  const RequestService2Widget({
    super.key,
...
class _RequestService2WidgetState extends State<RequestService2Widget> {
  late RequestService2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestService2Model());
