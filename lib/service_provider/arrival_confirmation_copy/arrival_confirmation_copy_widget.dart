...
class ArrivalConfirmationCopyWidget extends StatefulWidget {
  const ArrivalConfirmationCopyWidget({
    super.key,
  ...
  @override
  State<ArrivalConfirmationCopyWidget> createState() =>
      _ArrivalConfirmationCopyWidgetState();
}

class _ArrivalConfirmationCopyWidgetState
    extends State<ArrivalConfirmationCopyWidget> {
  late ArrivalConfirmationCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArrivalConfirmationCopyModel());
