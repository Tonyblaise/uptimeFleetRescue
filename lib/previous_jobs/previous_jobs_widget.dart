...
class _PreviousJobsWidgetState extends State<PreviousJobsWidget>
    with TickerProviderStateMixin {
  late PreviousJobsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviousJobsModel());
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                              ...
                              builder: (context, snapshot) {
                                ...
                                final listViewGetPreviousJobsResponse =
                                    snapshot.data!;

                                return Builder(
                                  builder: (context) {
                                    final jobs =
                                        UptimeFleetAppGroup.getPreviousJobsCall
                                                .requests(
                                                  listViewGetPreviousJobsResponse
                                                      .jsonBody,
                                                )
                                                ?.toList() ??
                                            [];
                                    if (jobs.isEmpty) {
                                      return SizedBox(
                                        ...
                                        child: EmptyStateSimpleWidget(
                                          ...
                                          body:
                                              'Previous jobs will be displayed here',
                                          action: () async {},
                                        ),
                                      );
                                    }
